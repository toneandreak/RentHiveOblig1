...
namespace RentHiveOblig.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,PropertyId,GuestId,Rating,Comment,DatePosted,ReviewImage1,ReviewImage2,ReviewImage3")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,PropertyId,GuestId,Rating,Comment,DatePosted,ReviewImage1,ReviewImage2,ReviewImage3")] Review review)
        {
