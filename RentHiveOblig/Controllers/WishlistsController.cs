...
namespace RentHiveOblig.Controllers
{
    public class WishlistsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("WishlistId,WishlistName,UserId,DateAdded")] Wishlist wishlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("WishlistId,WishlistName,UserId,DateAdded")] Wishlist wishlist)
        {
