...
namespace RentHiveOblig.Data.Migrations
{
    ...
    [Migration("20230918145148_MigrationReviewAndMore")]
    partial class MigrationReviewAndMore
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentHiveOblig.Models.Bruker", b =>
                {
                    b.Property<int>("BrukerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BrukerID"), 1L, 1);

                    b.Property<string>("BrukerEpost")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RentHiveOblig.Models.Eiendom", b =>
                {
                    ...
                    b.Property<string>("EiendomDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EiendomName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RentHiveOblig.Models.Review", b =>
                {
                    b.HasOne("RentHiveOblig.Models.Bruker", "Bruker")
                        .WithMany("Reviews")
